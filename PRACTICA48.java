...
public class PRACTICA48 {
    ...
    private static final String FILENAME = "D:/Users/Alumno/Desktop/PRACTICA_48/AUTOS.xml";
    ...
    public static void main(String[] args) {
        ...
        agregarCoche("003", "Tesla", "Model S", "2022", "blanco", "Eléctrico", "0", "1020", "automática", "1");
    ...
    public static void agregarCoche(String id, String marca, String modelo, String año, String color, String tipoMotor, String cilindrada, String potencia, String tipoTransmision, String velocidades) {
        try {
            File inputFile = new File(FILENAME);
            DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
            DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
